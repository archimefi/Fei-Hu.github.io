...
{% if post.header.teaser %}
  <p>
    <img src="{{ post.header.teaser | relative_url }}" alt="{{ post.title }} teaser" style="max-width: 280px; height: auto; border-radius: 6px;">
  </p>
{% endif %}
...
### Key contributions
- iCVD copolymerization via gas-phase transport of two monomers with distinct properties (not miscible in liquid/solution routes).
