...
- ⚡ Focus: Functional coatings by PVD and CVD, Li battery, operando diagnostics, aotumation robots
- 💬 Materials scientist with 7+ years’ experience bridging semiconductor thin films and next-gen batteries. I specialize in interfacial engineering—ultrathin PVD/CVD coatings and multifunctional layers (PVD (sputtering,E-beam and thermal evaporation) and CVD) that tune charge/ion transport, suppress parasitic reactions, and improve optical/mechanical/thermal reliability. I connect process → structure → interphase chemistry → performance using electrochemistry (plating/stripping, EIS), operando/thermal measurements, XPS, SEM, Raman, and advanced materials characterization (synchrotron XRD, nano-CT). I bring semiconductor-style rigor to electrochemical development with DOE/SPC, Design for Six Sigma, and Python-driven high-throughput automation (Opentrons/OP2) to accelerate sample screening and make data-driven decisions.
...
- **University of Rochester** — **Ph.D.**, Chemical Engineering (Aug 2020–Jan 2025)  
  Advisor: Prof. Wyatt E. Tenhaeff  
  Thesis: Development of thin-film materials to enhance the energy density, lifespan and safety of lithium batteries

- **University of Rochester** — **M.S.**, Chemical Engineering (Sep 2018–May 2020)  
  Advisor: Prof. Wyatt E. Tenhaeff

- **South China University of Technology** — **B.Eng.**, Energy Chemical Engineering (Double Major: Business Administration) (Sep 2014–Jun 2018)  
